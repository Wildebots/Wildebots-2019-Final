...
public class Robot extends TimedRobot {
    ...
    {
        Scheduler.getInstance().removeAll(); // Clean the CPU and remove all commands if they were previously occupied
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        CameraServer.getInstance().startAutomaticCapture("Front Low",0);
    }
