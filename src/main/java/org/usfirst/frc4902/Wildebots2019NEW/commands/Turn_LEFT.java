...
public class Turn_LEFT extends Command 
{
    ...
    public Turn_LEFT(double t_seconds) // Constructor
    {
    ...
    protected void execute() 
    {
        ...
        {
            Robot.driveTrain.drive(-1.0, 1.0); // Full Speed Turn LEFT. Speed values are between [-1.0..1.0]
            //System.out.println("Executing Turn_LEFT");
        }
    }
