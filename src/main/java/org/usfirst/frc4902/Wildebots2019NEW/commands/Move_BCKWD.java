...
public class Move_BCKWD extends Command 
{
    private final Timer m_timer = new Timer();
    private final double exe_seconds;

    public Move_BCKWD(double t_seconds) // Constructor
    {
    ...
    protected void execute() 
    {
        ...
        {
            Robot.driveTrain.drive(-1.0, -1.0); // Full Speed BCKWD. Speed values are between [-1.0..1.0]
            //System.out.println("Executing Move_BCKWD");
        }
